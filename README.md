...
To run the app locally, you'll need Visual Studio 2022, latest patch, to allow you to run dotnet 7 apps (I used v17.4.0). It'll also need the "Aspnet & Web Development" pack installed. You'll also need to be setup to run Angular, as described [here](https://angular.io/guide/setup-local). Once setup, there's a run.bat file at \LeedsBeerQuest.Web\leeds-beer-quest that installs the npm modules and then runs the app. 
